...
ParticularVerseModel _$ParticularVerseModelFromJson(Map<String, dynamic> json) {
  return _ParticularVerseModel.fromJson(json);
}

/// @nodoc
mixin _$ParticularVerseModel {
  @JsonKey(name: "id")
  ...
  @JsonKey(ignore: true)
  $ParticularVerseModelCopyWith<ParticularVerseModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ParticularVerseModelCopyWith<$Res> {
  factory $ParticularVerseModelCopyWith(ParticularVerseModel value,
          $Res Function(ParticularVerseModel) then) =
      _$ParticularVerseModelCopyWithImpl<$Res, ParticularVerseModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ParticularVerseModelCopyWithImpl<$Res,
        $Val extends ParticularVerseModel>
    implements $ParticularVerseModelCopyWith<$Res> {
  _$ParticularVerseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ParticularVerseModelImplCopyWith<$Res>
    implements $ParticularVerseModelCopyWith<$Res> {
  factory _$$ParticularVerseModelImplCopyWith(_$ParticularVerseModelImpl value,
          $Res Function(_$ParticularVerseModelImpl) then) =
      __$$ParticularVerseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int id,
...
/// @nodoc
class __$$ParticularVerseModelImplCopyWithImpl<$Res>
    extends _$ParticularVerseModelCopyWithImpl<$Res, _$ParticularVerseModelImpl>
    implements _$$ParticularVerseModelImplCopyWith<$Res> {
  __$$ParticularVerseModelImplCopyWithImpl(_$ParticularVerseModelImpl _value,
      $Res Function(_$ParticularVerseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ParticularVerseModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$ParticularVerseModelImpl implements _ParticularVerseModel {
  const _$ParticularVerseModelImpl(
  ...
  factory _$ParticularVerseModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$ParticularVerseModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ParticularVerseModel(id: $id, verseNumber: $verseNumber, chapterNumber: $chapterNumber, text: $text, translations: $translations, commentaries: $commentaries)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ParticularVerseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ParticularVerseModelImplCopyWith<_$ParticularVerseModelImpl>
      get copyWith =>
          __$$ParticularVerseModelImplCopyWithImpl<_$ParticularVerseModelImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ParticularVerseModelImplToJson(
      this,
    );
  }
}

abstract class _ParticularVerseModel implements ParticularVerseModel {
  const factory _ParticularVerseModel(
  ...
  factory _ParticularVerseModel.fromJson(Map<String, dynamic> json) =
      _$ParticularVerseModelImpl.fromJson;
